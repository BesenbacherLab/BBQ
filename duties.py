...
def release(ctx, version):
    ...
    ctx.run(f'sed -i "" "s/__version__ = .*/__version__ = \\"{version}\\"/g" src/betterbasequals/__init__.py')
    ctx.run("git add pyproject.toml src/betterbasequals/__init__.py", title="Staging files", pty=PTY)
