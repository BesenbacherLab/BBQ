...
#bbq train_only --input_file_good good_kmers_chr10.txt --input_file_bad bad_kmers_chr10.txt --output_file_kmerpapa kmerpapa_chr22-34-35.txt
 #poetry run bbq call_only --bam_file ~/Data/bam/panTro5/carl_F003_3MB.bam --twobit_file ~/Data/2bit/panTro5.2bit --input_file_kmerpapa tmp/tmp_kmerpapa2.txt  > test4.txt
#poetry run bbq list_validate_only --bam_file ~/Data/bam/panTro5/carl_F003_3MB.bam --twobit_file ~/Data/2bit/panTro5.2bit --input_file_kmerpapa tmp/tmp_kmerpapa2.txt --filter_bam_file ~/Data/bam/panTro5/carl_F003_3MB.bam --validation_list_file Carl_3MB_validation_list.txt > tmp_Carl_3MB_validation.txt
